# X launch thread draft (English)

1/ The coin is called SCAM. The project is a museum for studying smart-contract attack patterns — not a live scam detector.

2/ The archive explains patterns such as missing access control, reentrancy, unsafe delegate calls, and repeatable initializers. Educational summaries are not findings about any particular live project.
...
5/ The initial launch buy was burned. The creator may hold tokens acquired separately, so current balances should be checked on-chain.
